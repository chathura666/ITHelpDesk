                    ...
                    <div class="error-content">
                        <div class="card mb-0">
                            <div class="card-body text-center">
                                ...
                                <h3 class="mt-4"><i class="fa fa-thumbs-down text-danger">&nbsp&nbsp&nbsp</i>Login Failed</h3>
                                <p></p>
                                <h6 class="mt-4">Invalid Username or Password </h6>
                                <form class="mt-5 mb-5">
                                    
                                    <div class="text-center mb-4 mt-4"><a href="<?php echo base_url('/login'); ?>" class="btn btn-primary">Go back</a>
                                    </div>
                                </form>
                            </div>
                        </div>
