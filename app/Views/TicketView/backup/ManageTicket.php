...
<script src="<?php echo base_url('js/offline/buttons.print.min.js'); ?>"></script>
                                                        ...
                                                        <table id="myTable" class="display table table-striped table-bordered">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>                                                                 
                                                                    ...
                                                                    <td><span>  
                                                                    <a href="#" onclick="checkStatusaAndEdit('<?php echo $tickets->id; ?>','<?php echo $tickets->status; ?>')" data-toggle="tooltip" data-placement="top" title="Manage"><i class="fa fa-pencil"></i> </a>
    ...
    function checkStatusaAndEdit(id,status) {
       ...
       // alert(status);
        if (status === "5") {
            Swal.fire("Information!", "Ticket is already processed.", "info");
    } else {

        window.location.href = '<?php echo base_url('ticket/manage'); ?>'+'/'+id;
