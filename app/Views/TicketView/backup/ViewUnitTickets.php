                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    <div class="table-responsive">
                                                        <table id="myTable" class="display table table-striped table-bordered" style="width: 1039.6px;font-size: small;">
                                                            <thead>
                                                                <tr>
                                                                    <th>ID</th> 
                                                                ...
                                                                <tr>                                                                 
                                                                    ...
                                                                    <?php
                                                                                        ...
                                                                                        switch ($status) {
                                                                                            case 1:
                                                                                                ?>
                                                                                                <span class="badge badge-primary" style="width:70px"><b>Open</b></span></td>                                                                                            <?php
                                                                                                break;
                                                                                            case 2:
                                                                                                ?>
                                                                                                <span class="badge badge-secondary" style="width:70px"><b>Working</b></span></td>
                                                                                                <?php
                                                                                                break;
                                                                                            case 3:
                                                                                                ?>
                                                                                                <span class="badge badge-success" style="width:70px"><b>Closed</b></span></td>
                                                                                                <?php
                                                                                                break;
                                                                                            case 4:
                                                                                                ?>
                                                                                                <span class="badge badge-success" style="width:70px"><b>Re-Opened</b></span></td>
                                                                                                <?php
                                                                                                break;
                                                                                            case 5:
                                                                                                ?>
                                                                                                <span class="badge badge-warning" style="width:70px"><b>Approval</b></span></td>
                                                                                                <?php
                                                                                                break;
                                                                                            case 6:
                                                                                                ?>
                                                                                                <span class="badge badge-dark" style="width:70px"><b>Approved</b></span></td>
                                                                                                <?php
                                                                                                break;        
                                                                                            default:
                                                                                                ?>
                                                                    ...
                                                                    <td><span>  
                                                                    <a href="#" onclick="assignTicketToUser('<?php echo $tickets->id; ?>','<?php echo $_SESSION['user_id']; ?>')" data-toggle="tooltip" data-placement="top" title="Assign to me"><i class="fa fa-sign-in "></i> </a>
