...
function assignTicketToUser(id,agent) {
...
if (ticketid === "") {
                ...
                if (userid === "") {
                    Swal.fire("Information!", "User Not Selected!", "info");
                        ...
                        Swal.fire({
                            title: 'Are you sure?',
                            text: "Ticket will be assigned to you!",
                            icon: 'warning',
                                ...
                                $.ajax({
                                    ...
                                    success: function (response) {
                                        ...
                                        if (response && response.status == "success") {
                                            ...
                                            Swal.fire("Done!", "Assigned Successully!", "success")
                                                .then((value) => {
                                                        ...
                                                        <table id="myTable" class="display table table-striped table-bordered" style="font-size: small;">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>                                                                 
                                                                    ...
                                                                    <td><span>
                                                                    <a href="#" id="assignToMe" onclick="assignTicketToUser('<?php echo $tickets->id; ?>','<?php echo $_SESSION['user_id']; ?>')" data-toggle="tooltip" data-placement="top" title="Assign to me"><i class="fa fa-sign-in "></i> </a>
