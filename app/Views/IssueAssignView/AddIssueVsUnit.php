                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-3">
                                                    ...
                                                    <select name="uid" id="inputState" class="form-control">
                                            ...
                                            <div class="form-group col-md-3">
                                                    ...
                                                    <select name="issue_id" id="inputState" class="form-control">
                                                    <option selected="selected">Select Issue Description...</option>
                                            ...
                                            <div class="input-group-append">
                                                ...
                                                <button class="btn btn-outline-dark" style="height: 45px;" type="submit" href="<?php echo base_url('/issueVsUnit/save');?>" >Assign Issue </button>
                                            </div>
                                            </div>
                                        </div>
                                        </form></div>
