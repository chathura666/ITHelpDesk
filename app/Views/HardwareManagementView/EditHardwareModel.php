                ...
                <div class="card">
                    <div class="card-body">
                        <div class="basic-form">
                            <form action="<?php echo base_url('/hardwaremodels/update');?>" method="post" accept-charset="utf-8">
                                    ...
                                    <form>
                                        <div class="form-row">
                                            ...
                                            <div class="input-group-append">
                                                ...
                                                <button class="btn btn-outline-dark" style="height: 45px;" type="submit" href="<?php echo base_url('/hardwaremodels/update');?>" >Update Hardware</button>
                                            </div>
                                            </div>
                                        </div>
                                        </form></div>
                                                    ...
                                                    <table id="myTable" class="display table table-striped table-bordered zero-configuration">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>                                                                   
                                                                    ...
                                                                    <td><span><a href="<?php echo base_url('hardwaremodels/edit/'.$model->id);?>" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fa fa-pencil color-muted m-r-5"></i> </a>
                                                                    <a href="<?php echo base_url('hardwaremodels/delete/'.$model->id);?>" data-toggle="tooltip" data-placement="top" title="Delete"><i class="fa fa-trash color-danger"></i></a></span>                                                                    
                                                                    </td>
                                                                </tr>
                                                                <?php endforeach ?>
                                                            </tbody>                                                           
