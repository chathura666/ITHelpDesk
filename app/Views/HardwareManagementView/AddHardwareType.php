                ...
                <div class="card">
                    <div class="card-body">
                        <div class="basic-form">
                            <form action="<?php echo base_url('/hardwaretypes/save');?>" method="post" accept-charset="utf-8">
                                    ...
                                    <form>
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <input type="text" class="form-control" name="hardwarename">
                                            </div>
                                            <div class="form-group col-md-4">
                                                <label>Status</label>                                             
                                            ...
                                            <div class="input-group-append">
                                                ...
                                                <button class="btn btn-outline-dark" style="height: 45px;" type="submit" href="<?php echo base_url('/hardwaretypes/save');?>" >Add Hardware</button>
                                            </div>
                                            </div>
                                        </div>
                                        </form></div>
