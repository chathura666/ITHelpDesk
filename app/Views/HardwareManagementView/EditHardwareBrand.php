                ...
                <div class="card">
                    <div class="card-body">
                        <div class="basic-form">
                            <form action="<?php echo base_url('/hardwarebrands/update');?>" method="post" accept-charset="utf-8">
                                    ...
                                    <form>
                                        <div class="form-row">
                                            ...
                                            <div class="input-group-append">
                                                ...
                                                <button class="btn btn-outline-dark" style="height: 45px;" type="submit" href="<?php echo base_url('/hardwarebrands/update');?>" >Update Hardware</button>
                                            </div>
                                            </div>
                                        </div>
                                        </form></div>
