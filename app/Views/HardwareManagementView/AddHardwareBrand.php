                ...
                <div class="card">
                    <div class="card-body">
                        <div class="basic-form">
                            <form action="<?php echo base_url('/hardwarebrands/save');?>" method="post" accept-charset="utf-8">
                                    ...
                                    <form>
                                        <div class="form-row">
                                            ...
                                            <div class="input-group-append">
                                                ...
                                                <button class="btn btn-outline-dark" style="height: 45px;" type="submit" href="<?php echo base_url('/hardwarebrands/save');?>" >Add Hardware Brand</button>
                                            </div>
                                            </div>
                                        </div>
                                        </form></div>
